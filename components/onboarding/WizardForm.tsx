...
export function WizardForm({
  ...
  return (
    <div className="flex flex-col gap-8">
      {/* The language switcher lives on the form and not only in the header,
          because the moment somebody realises they are reading the wrong
          language is the moment they are looking at a field they cannot fill.
          It carries the step across, so switching does not restart the form. */}
      <div className="flex items-center justify-end gap-2 text-sm">
        <span className="text-ink-mute">{t.languageLabel}</span>
          ...
          <a
            ...
            className={
              l === locale
                ...
                : 'text-ink-soft hover:text-brand-accent'
            }
          >
            {LOCALE_NAME[l]}
          </a>
